...
#Escribe una función que dados (1) el nombre de un archivo de texto y (2) un nombre para un nuevo archivo, permita crear un archivo que sea el mismo que el (1) pero con las líneas numeradas. Cada línea del archivo de salida debe empezar con el n ́umero correspondiente, seguido de un par ́entesis y un espacio.
